...
<head>
  <meta name="description"
        content="The biggest Google tech conference in Vietnam carefully crafted for you by GDG community! All about Android, Web and Cloud from the world experts">
  <meta name="keywords"
  ...
  <title>GDG DevFest Vietnam 2016</title>
  ...
```
...
"pages": {
  "home": {
    "headerSettings": {
      ...
      "video": {
        "title": "GDG DevFest Vietnam 2016",
